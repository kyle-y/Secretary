 ...
 * MODIFY_BY:
 */
public class GetMoneySettingActivity extends BaseActivity {
    @BindView(R.id.text_getmoney_money)
    EditText textGetmoneyMoney;
    @BindView(R.id.button_getmoney_confirm)
    Button buttonGetmoneyConfirm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_money_setting);
    ...
    @OnClick(R.id.button_getmoney_confirm)
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button_getmoney_confirm:
                ...
                GetMoneySettingActivity.this.addSubscription(newUser.update(user.getObjectId(),new UpdateListener() {
                    @Override
                ...
                intent.putExtra("money", textGetmoneyMoney.getText().toString());
                intent.putExtra("isShowHead", isShowHead);
                intent.setClass(MyApplication.getContext(), GetMoneyActivity.class);
                startActivity(intent);
                GetMoneySettingActivity.this.finish();
                break;
        }
    }
}
