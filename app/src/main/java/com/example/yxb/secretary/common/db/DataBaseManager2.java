 ...
 */
public class DataBaseManager2<T> {
    private DBHelper2 dbHelper2;
    public static DataBaseManager2 instance = null;
     ...
     * @return
     */
    public static final DataBaseManager2 getInstance(Context context){
        if(instance == null){
            if(context == null){
                throw new RuntimeException("Context is null");
            }
            instance = new DataBaseManager2(context);
        }
        return instance;
    }
